    ...
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.H2,
        {
          ...
          Better care, better health.</Text>
        <Text style={styles.title,
        {
          fontSize: 12,
          alignSelf: "center"
        }}>
          A Black healthcare app ending racial healthcare disparities.</Text>
        <Text></Text>
        {this.props.user.isBarber && !this.props.user.completedReg && (
          <View style={styles.completeReg}>
            <TouchableOpacity
              ...
              <Text style={{ alignSelf: "center", fontSize: 20, padding: 10 }}> Incomplete Provider Listing! </Text>
              <Text style={{ alignSelf: "center", paddingBottom: 8, color: "white" }}> Click here to complete your provider profile</Text>
              <Text style={{ alignSelf: "center" }}> Check www.blackmdcares.com to confirm</Text>
            </TouchableOpacity>
          </View>)
        }
